...
import cn.edu.fjnu.racingplan.activity.AboutActivity;
import cn.edu.fjnu.racingplan.activity.LoginActivity;
import cn.edu.fjnu.racingplan.activity.SuggestionActivity;
        ...
        mLayoutAbout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new AlertDialog.Builder(getActivity()).setTitle(getActivity().getString(R.string.app_name))
                        .setMessage("最全的北京赛车资讯分享平台").setPositiveButton("确定", null).show();
            }
        });
